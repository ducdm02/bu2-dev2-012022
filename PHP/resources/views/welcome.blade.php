...
<div id="myBtnContainer">
  ...
  <button  type="button" class="btn btn-outline-secondary" onclick="filterSelection('Thuốc dạ dày')"> Thuốc dạ dày</button>
  <button  type="button" class="btn btn-outline-secondary" onclick="filterSelection('Thuốc cảm')"> Thuốc cảm</button>
